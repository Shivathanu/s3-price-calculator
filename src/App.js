...
class App extends Component {
    constructor() {
        ...
        this.state = { region: Object.keys(regionDisplay)[0], dataSize: 100, postPutRequests: 100, getRequests: 100, dataTransferSize: 100 }
    }
    ...
    render() {
        ...
        return (
            <div className="App">
                ...
                <div className="jumbotron col-sm-10 col-sm-offset-1" style={ {background: 'transparent'} }>
